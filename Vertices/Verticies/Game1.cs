...
namespace Vertices
{
    ...
    public class Game1 : Game
    {
        ...
        private void SetUpVertices()
        {
            ...
            vertices[7] = new VertexPositionColor(new Vector3(-1, 1, 2), Color.Blue);
            vertices[8] = new VertexPositionColor(new Vector3(1, 1, 2), Color.Blue);
            vertices[9] = vertices[0];
            vertices[10] = vertices[4];
            vertices[11] = vertices[8];
            vertices[12] = vertices[0];

            vertices[13] = new VertexPositionColor(new Vector3(-1, 1, -2), Color.Green);
            vertices[14] = new VertexPositionColor(new Vector3(1, 1, -2), Color.Green);
